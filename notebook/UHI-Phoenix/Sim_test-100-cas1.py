...
if __name__ == '__main__':
    ...
    nodata = pf['nodata']
    #affine.Affine(a, b, c,d, e, f)# gdal Orders：(c, a, b, f, d, e)
    print(f'affine parameters（six）：\n {transform}')
    time_dif = [0.0,5.0,5.0,5.0,5.0]
 
    np.random.seed(42)
    beta0  = 1*np.ones((353,353))
    beta1  = 2*np.ones((353,353))
    beta2  = -2*np.ones((353,353))
    beta3  = -1*np.ones((353,353))
    ...
    with open('D:/STWR/Data-Run/results/case1/normal_errs.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/y_surface_2000.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(lst95.shape))
        np.savetxt(outfile, lst95, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/y_surface_2005.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(lst00.shape))
        np.savetxt(outfile, lst00, fmt='%-7.7f')
    with open('D:/STWR/Data-Run/results/case1/y_surface_2010.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(lst05.shape))
        np.savetxt(outfile, lst05, fmt='%-7.7f')
    with open('D:/STWR/Data-Run/results/case1/y_surface_2015.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(lst10.shape))
        np.savetxt(outfile, lst10, fmt='%-7.7f')
    with open('D:/STWR/Data-Run/results/case1/y_surface_2020.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(lst15.shape))
    ...
    for rand_times in range(random_times):
                ...
                #pred_y_tick = cal_y_tick = lst91.flatten()[mask_ticks_91]
                ...
                X_all_tol.append(np.concatenate((b95gpnbi_f.flatten().reshape((-1,1)),
                                                 b95gndvi_f.flatten().reshape((-1,1)),b95moran_f.flatten().reshape((-1,1))),axis=1))
                ...
                X_all_tol.append(np.concatenate((b00gpnbi_f.flatten().reshape((-1,1)),
                                     b00gndvi_f.flatten().reshape((-1,1)),b00moran_f.flatten().reshape((-1,1))),axis=1))
                ...
                X_all_tol.append(np.concatenate((b05gpnbi_f.flatten().reshape((-1,1)),
                                     b05gndvi_f.flatten().reshape((-1,1)),b05moran_f.flatten().reshape((-1,1))),axis=1))
                ...
                X_all_tol.append(np.concatenate((b10gpnbi_f.flatten().reshape((-1,1)),
                                     b10gndvi_f.flatten().reshape((-1,1)),b10moran_f.flatten().reshape((-1,1))),axis=1))
                #15
                ...
                X_all_tol.append(np.concatenate((b15gpnbi_f.flatten().reshape((-1,1)),
                         b15gndvi_f.flatten().reshape((-1,1)),b15moran_f.flatten().reshape((-1,1))),axis=1))
                ...
                ###############OLS prediction############################
                #beta1 * b95gpnbi_f + beta2 * b95gndvi_f + beta3 * b95moran_f
    ...
    with open('D:/STWR/Data-Run/results/case1/100_test_olsbeta_1000_hc.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(ols_betas.shape))
        np.savetxt(outfile, ols_betas, fmt='%-7.7f')


    with open('D:/STWR/Data-Run/results/case1/100_test_olspredy_1000_hc.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(ols_predy_arr.shape))
        for data_slice in ols_predy_arr:
            np.savetxt(outfile, data_slice, fmt='%-7.7f')
            outfile.write('# New slice\n')

    with open('D:/STWR/Data-Run/results/case1/100_test_gwr_predbeta0arr_1000_hc.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(gwr_predbeta0_arr.shape))
        for data_slice in gwr_predbeta0_arr:
            np.savetxt(outfile, data_slice, fmt='%-7.7f')
            outfile.write('# New slice\n')
    with open('D:/STWR/Data-Run/results/case1/100_test_gwr_predbeta1arr_1000_hc.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(gwr_predbeta1_arr.shape))
        for data_slice in gwr_predbeta1_arr:
            np.savetxt(outfile, data_slice, fmt='%-7.7f')
            outfile.write('# New slice\n')
    with open('D:/STWR/Data-Run/results/case1/100_test_gwr_predbeta2arr_1000_hc.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(gwr_predbeta2_arr.shape))
        for data_slice in gwr_predbeta2_arr:
            np.savetxt(outfile, data_slice, fmt='%-7.7f')
            outfile.write('# New slice\n')
    with open('D:/STWR/Data-Run/results/case1/100_test_gwr_predbeta3arr_1000_hc.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(gwr_predbeta3_arr.shape))
        for data_slice in gwr_predbeta3_arr:
            np.savetxt(outfile, data_slice, fmt='%-7.7f')
            outfile.write('# New slice\n')
    with open('D:/STWR/Data-Run/results/case1/100_test_gwr_predy_arr_1000_hc.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(gwr_predy_arr.shape))
        for data_slice in gwr_predy_arr:
            np.savetxt(outfile, data_slice, fmt='%-7.7f')
            outfile.write('# New slice\n')
    #STWR
    with open('D:/STWR/Data-Run/results/case1/100_test_stwr_predbeta0arr_1000_hc.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(stwr_predbeta0_arr.shape))
        for data_slice in stwr_predbeta0_arr:
            np.savetxt(outfile, data_slice, fmt='%-7.7f')
            outfile.write('# New slice\n')
    with open('D:/STWR/Data-Run/results/case1/100_test_stwr_predbeta1arr_1000_hc.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(stwr_predbeta1_arr.shape))
        for data_slice in stwr_predbeta1_arr:
            np.savetxt(outfile, data_slice, fmt='%-7.7f')
            outfile.write('# New slice\n')
    with open('D:/STWR/Data-Run/results/case1/100_test_stwr_predbeta2arr_1000_hc.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(stwr_predbeta2_arr.shape))
        for data_slice in stwr_predbeta2_arr:
            np.savetxt(outfile, data_slice, fmt='%-7.7f')
            outfile.write('# New slice\n')
    with open('D:/STWR/Data-Run/results/case1/100_test_stwr_predbeta3arr_1000_hc.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(stwr_predbeta3_arr.shape))
        for data_slice in stwr_predbeta3_arr:
            np.savetxt(outfile, data_slice, fmt='%-7.7f')
            outfile.write('# New slice\n')
    with open('D:/STWR/Data-Run/results/case1/100_test_stwr_predy_arr_1000_hc.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/stwr_predy_means.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(stwr_predy_means.shape))
        np.savetxt(outfile, stwr_predy_means, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/gwr_predy_means.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(gwr_predy_means.shape))
        np.savetxt(outfile, gwr_predy_means, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/ols_predy_means.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/y_self_err.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(y_self_err.shape))
        np.savetxt(outfile, y_self_err, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/y_pre_stwr_err.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(y_pre_stwr_err.shape))
        np.savetxt(outfile, y_pre_stwr_err, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/gs_stwr_err2.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(y_pre_gwr_err.shape))
        np.savetxt(outfile, y_pre_gwr_err, fmt='%-7.7f')
    with open('D:/STWR/Data-Run/results/case1/y_pre_ols_eee.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/stwr_predbeta0_means.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(stwr_predbeta0_means.shape))
        np.savetxt(outfile, stwr_predbeta0_means, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/stwr_predbeta1_means.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(stwr_predbeta1_means.shape))
        np.savetxt(outfile, stwr_predbeta1_means, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/stwr_predbeta2_means.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(stwr_predbeta2_means.shape))
        np.savetxt(outfile, stwr_predbeta2_means, fmt='%-7.7f')
    with open('D:/STWR/Data-Run/results/case1/stwr_predbeta3_means.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/gwr_predbeta0_means.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(gwr_predbeta0_means.shape))
        np.savetxt(outfile, gwr_predbeta0_means, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/gwr_predbeta1_means.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(gwr_predbeta1_means.shape))
        np.savetxt(outfile, gwr_predbeta1_means, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/gwr_predbeta2_means.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(gwr_predbeta2_means.shape))
        np.savetxt(outfile, gwr_predbeta2_means, fmt='%-7.7f')
    with open('D:/STWR/Data-Run/results/case1/gwr_predbeta3_means.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/ppstwr_abm_err_beta0.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(ppstwr_err_beta0.shape))
        np.savetxt(outfile, ppstwr_err_beta0, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/ppstwr_abm_err_beta1.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(ppstwr_err_beta1.shape))
        np.savetxt(outfile, ppstwr_err_beta1, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/ppstwr_abm_err_beta2.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(ppstwr_err_beta2.shape))
        np.savetxt(outfile, ppstwr_err_beta2, fmt='%-7.7f')
    with open('D:/STWR/Data-Run/results/case1/ppstwr_amb_err_beta3.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(ppstwr_err_beta3.shape))
        np.savetxt(outfile, ppstwr_err_beta3, fmt='%-7.7f')


    with open('D:/STWR/Data-Run/results/case1/ppgwr_abm_err_beta0.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(ppgwr_err_beta0.shape))
        np.savetxt(outfile, ppgwr_err_beta0, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/ppgwr_abm_err_beta1.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(ppgwr_err_beta1.shape))
        np.savetxt(outfile, ppgwr_err_beta1, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/ppgwr_abm_err_beta2.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(ppgwr_err_beta2.shape))
        np.savetxt(outfile, ppgwr_err_beta2, fmt='%-7.7f')
    with open('D:/STWR/Data-Run/results/case1/ppgwr_abm_err_beta3.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/ols_abm_err_beta0.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/ols_abm_err_beta1.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/ols_abm_err_beta2.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/ols_abm_err_beta3.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/stwr_params0_mean_err.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(ppstwr_eee_beta0.shape))
        np.savetxt(outfile, ppstwr_eee_beta0, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/stwr_params1_mean_err.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(ppstwr_err_beta1.shape))
        np.savetxt(outfile, ppstwr_err_beta1, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/stwr_params2_mean_err.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(ppstwr_eee_beta2.shape))
        np.savetxt(outfile, ppstwr_eee_beta2, fmt='%-7.7f')
    with open('D:/STWR/Data-Run/results/case1/stwr_params3_mean_err.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(ppstwr_eee_beta3.shape))
        np.savetxt(outfile, ppstwr_eee_beta3, fmt='%-7.7f')


    with open('D:/STWR/Data-Run/results/case1/gwr_params0_mean_err.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(ppgwr_eee_beta0.shape))
        np.savetxt(outfile, ppstwr_eee_beta0, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/gwr_params1_mean_err.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(ppgwr_err_beta1.shape))
        np.savetxt(outfile, ppstwr_err_beta1, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/gwr_params2_mean_err.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(ppgwr_eee_beta2.shape))
        np.savetxt(outfile, ppstwr_eee_beta2, fmt='%-7.7f')
    with open('D:/STWR/Data-Run/results/case1/gwr_params3_mean_err.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(ppgwr_eee_beta3.shape))
        np.savetxt(outfile, ppstwr_eee_beta3, fmt='%-7.7f')


    with open('D:/STWR/Data-Run/results/case1/ols_merr_beta0.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/ols_merr_beta1.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/ols_merr_beta2.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/ols_merr_beta3.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/rmse_stwr_predy.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(rmse_stwr_predy.shape))
        np.savetxt(outfile, rmse_stwr_predy, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/rmse_gwr_predy.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(rmse_gwr_predy.shape))
        np.savetxt(outfile, rmse_gwr_predy, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/rmse_ols_predy.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/rmse_stwr_beta0.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(rmse_stwr_beta0.shape))
        np.savetxt(outfile, rmse_stwr_beta0, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/rmse_gwr_beta0.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(rmse_gwr_beta0.shape))
        np.savetxt(outfile, rmse_gwr_beta0, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/rmse_ols_beta0.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/rmse_stwr_beta1.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(rmse_stwr_beta1.shape))
        np.savetxt(outfile, rmse_stwr_beta1, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/rmse_gwr_beta1.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(rmse_gwr_beta1.shape))
        np.savetxt(outfile, rmse_gwr_beta1, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/rmse_ols_beta1.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/rmse_stwr_beta2.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(rmse_stwr_beta2.shape))
        np.savetxt(outfile, rmse_stwr_beta2, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/rmse_gwr_beta2.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(rmse_gwr_beta2.shape))
        np.savetxt(outfile, rmse_gwr_beta2, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/rmse_ols_beta2.txt', 'w') as outfile:
    ...
    with open('D:/STWR/Data-Run/results/case1/rmse_stwr_beta3.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(rmse_stwr_beta3.shape))
        np.savetxt(outfile, rmse_stwr_beta3, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/rmse_gwr_beta3.txt', 'w') as outfile:
        outfile.write('# Array shape: {0}\n'.format(rmse_gwr_beta3.shape))
        np.savetxt(outfile, rmse_gwr_beta3, fmt='%-7.7f')

    with open('D:/STWR/Data-Run/results/case1/rmse_ols_beta3.txt', 'w') as outfile:
